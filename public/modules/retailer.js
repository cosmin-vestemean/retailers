    ...
    return `
          <div class="column coumn-is-third">
            ...
            <footer class="card-footer">
              ...
              <a href="${this.#trdr === 11654 ? 'new_retailer_file_manager/html' : 'retailer_file_manager.html'}.html?trdr=${this.#trdr}&logo='${this.#logo}'" class="card-footer-item eMag">File manager</a>
