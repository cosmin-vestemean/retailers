...
model: ['Claude Opus 5', 'Claude Opus 4.8', 'Claude Opus 4.7']
...
4. Produce an execution todo list. Classify EACH step by role and annotate it with the model from the Model Map in `.github/instructions/model-policy.instructions.md`, e.g. `- [ ] Refactor module X (model: Claude Sonnet 5)`.
